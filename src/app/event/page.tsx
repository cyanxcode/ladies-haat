...
export default function Event(){
    return (
        <>
            ...
            <div className="flex flex-col w-full items-center mt-12 gap-12">
                <h2 className="text-3xl font-bold">Welcome to Event Page</h2>
                <h3 className="text-xl font-semibold text-center">Win Exciting Prizes like earbuds, cloths, etc. Just by entering the code in your coupon.</h3>
